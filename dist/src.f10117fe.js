...
},{"./../utils":"node_modules/axios/lib/utils.js","./../core/settle":"node_modules/axios/lib/core/settle.js","./../helpers/cookies":"node_modules/axios/lib/helpers/cookies.js","./../helpers/buildURL":"node_modules/axios/lib/helpers/buildURL.js","../core/buildFullPath":"node_modules/axios/lib/core/buildFullPath.js","./../helpers/parseHeaders":"node_modules/axios/lib/helpers/parseHeaders.js","./../helpers/isURLSameOrigin":"node_modules/axios/lib/helpers/isURLSameOrigin.js","../core/createError":"node_modules/axios/lib/core/createError.js"}],"../../../../../AppData/Roaming/nvm/v13.12.0/node_modules/parcel-bundler/node_modules/process/browser.js":[function(require,module,exports) {
...
},{"./utils":"node_modules/axios/lib/utils.js","./helpers/normalizeHeaderName":"node_modules/axios/lib/helpers/normalizeHeaderName.js","./adapters/xhr":"node_modules/axios/lib/adapters/xhr.js","./adapters/http":"node_modules/axios/lib/adapters/xhr.js","process":"../../../../../AppData/Roaming/nvm/v13.12.0/node_modules/parcel-bundler/node_modules/process/browser.js"}],"node_modules/axios/lib/core/dispatchRequest.js":[function(require,module,exports) {
'use strict';
...
function () {
  function Eventing() {
    ...
    this.trigger = function (eventName) {
      if (_this.events[eventName]) _this.events[eventName].forEach(function (event) {
        return event();
      });
    };
  }
...
function () {
  ...
  Model.prototype.set = function (newValue) {
    ...
    return __awaiter(this, void 0, Promise, function () {
      ...
      return __generator(this, function (_a) {
        ...
        , new Promise(function (resolve, reject) {
          _this.sync.fetch(id).then(function (result) {
  ...
  Model.prototype.save = function () {
    return __awaiter(this, void 0, Promise, function () {
      ...
      return __generator(this, function (_a) {
        ...
        /*return*/
        , new Promise(function (resolve, reject) {
          _this.sync.save(_this.attributes.getAll()).then(function (result) {
            _this.set(result.data);
...
function () {
  function Attributes(data) {
    ...
    this.set = function (newValues) {
      Object.assign(_this.data, newValues);
    };
...
function (_super) {
  ...
  User.buildUser = function (attr) {
    return new User(new Attributes_1.Attributes(attr), new Eventing_1.Eventing(), new APISync_1.APISync(rootURL));
  };
...
exports.User = User;
},{"./Model":"src/models/Model.ts","./APISync":"src/models/APISync.ts","./Eventing":"src/models/Eventing.ts","./Attributes":"src/models/Attributes.ts"}],"src/models/Collection.ts":[function(require,module,exports) {
"use strict";
      ...
      return __generator(this, function (_a) {
        ...
        , new Promise(function (resolve, reject) {
          axios_1.default.get(_this.rootURL).then(function (response) {
            _this.models = response.data.map(function (user) {
              return User_1.User.buildUser(user);
            });
...
init();
},{"./models/Collection":"src/models/Collection.ts"}],"../../../../../AppData/Roaming/nvm/v13.12.0/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../../AppData/Roaming/nvm/v13.12.0/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/index.ts"], null)
