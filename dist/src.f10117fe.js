...
function (_super) {
  ...
  User.buildUserCollection = function () {
    return new Collection_1.Collection(rootURL, this.buildUser);
  };

  User.prototype.setRandomAge = function () {
    var age = Math.floor(Math.random() * 80) + 10;
    this.set({
      age: age
    });
  };
...
},{"./Views/UserEdit":"src/Views/UserEdit.ts","./models/User":"src/models/User.ts"}],"../../../../../AppData/Roaming/nvm/v13.12.0/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
